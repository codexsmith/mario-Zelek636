...
public class Valley implements GameBlock {
    ...
    public Valley(GameBlock parent, int origX, int maxLength, int difficulty){
        parentBlock = parent;
        absPos = origX;
    ...
    public int Add(int type) {
        if (type == 0)
            actualLength = nsLevel.LEVEL.buildValley(absPos, possibleLength);
        return actualLength;
    }
