...
import dk.itu.mario.engine.Scale2x;
...
/**
 *
 * @author MARIOCOMPONENT
 * @Editor Nicholas 
 */
public class randomMarioComponent extends MarioComponent implements Runnable, KeyListener, FocusListener, MouseListener {
    
    private static final long serialVersionUID = 739318775993206608L;
    ...
    public randomMarioComponent(int width, int height,boolean isCustomized){
                        super(width,height,isCustomized);
